...
class Settings(BaseSettings):
    ...
    DEMUCS_STEMS: List[str] = field(default_factory=lambda: [
    ...
    # Search & Download
    AUDIO_SOURCES: List[str] = field(default_factory=lambda: [
        "youtube_music", "youtube", "soundcloud", "bandcamp"
    ])
...
class TrackOutput:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "loops": {
                str(bar): {section: [str(p) for p in paths] for section, paths in sections.items()}
